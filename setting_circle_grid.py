...
def btn_execute_action(event):
        ...
        # 円中心ポイントAz, Evを使って
        # ObjectPointオブジェクト生成
        centerPoint = objectPoint(Az=float(txt_cirCtrAz.get()), Ev=float(txt_cirCtrEv.get()))
...
# ★ スタティックテキスト ★
# ★★★★★★★★★★★★★★★
Static01 = ttk.Label(frm, text=u'円ガイド生成', justify='left')
Static02 = ttk.Label(frm, text=u'全天球半径', justify='left')
Static03 = ttk.Label(frm, text=u'円の中心', justify='left')
Static04 = ttk.Label(cirCtrFrm, text=u'Az', justify='left')
Static05 = ttk.Label(cirCtrFrm, text=u'Ev', justify='left')
Static06 = ttk.Label(frm, text=u'円半径', justify='left')
